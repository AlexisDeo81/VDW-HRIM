            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal" action="{{ route('employeeDocument/add/save') }}"
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input class="form-control @error('path') is-invalid @enderror"
                                                    name="path" type="file" id="path" multiple="">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input class="form-control @error('name') is-invalid @enderror"
                                                    name="name" type="text" id="name" placeholder="Enter File Name">
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person-square"></i>
                                                </div>
                                                @error('name')
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <select class="form-select @error('user_name') is-invalid @enderror"
                                    ...
                                    <div class="form-group position-relative has-icon-left mb-4">
                                        <input class="form-control @error('uploaded_by') is-invalid @enderror"
                                            name="uploaded_by" value="1" type="hidden" id="uploaded_by"
