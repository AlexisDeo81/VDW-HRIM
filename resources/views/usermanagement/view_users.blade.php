                            ...
                            <div class="form-body">
                                ...
                                <div class="col-md-4">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                                    placeholder="First Name" id="my-input" name="first_name" value="{{ $data[0]->first_name }}">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control @error('middle_name') is-invalid @enderror"
                                                    placeholder="MiddleName" id="my-input" name="middle_name" value="{{ $data[0]->middle_name }}">
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person-lines-fill"></i>
                                                </div>
                                                @error('middle_name')
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                                    placeholder="LastName" id="my-input" name="last_name" value="{{ $data[0]->last_name }}">
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person-lines-fill"></i>
                                                </div>
                                                @error('last_name')
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                    placeholder="Email" id="my-input" name="email" value="{{ $data[0]->email }}">
                                                <div class="form-control-icon">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            <fieldset class="form-group">
                                                <select class="form-select" name="line_manager" id="my-input">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control @error('maxicare_card_number') is-invalid @enderror"
                                                    placeholder="Card number" id="my-input" name="maxicare_card_number" value="{{ $data[0]->maxicare_card_number }}">
                                                <div class="form-control-icon">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control @error('maxicare_policy_number') is-invalid @enderror"
                                                    placeholder="Policy number" id="my-input" name="maxicare_policy_number" value="{{ $data[0]->maxicare_policy_number }}">
                                                <div class="form-control-icon">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control @error('job_title') is-invalid @enderror"
                                                    placeholder="Job Title" id="my-input" name="job_title" value="{{ $data[0]->job_title }}">
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person-lines-fill"></i>
                                                </div>
                                                @error('job_title')
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            <fieldset class="form-group">
                                                <select class="form-select" name="job_status" id="my-input">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            <fieldset class="form-group">
                                                <select class="form-select" name="status" id="my-input">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            <fieldset class="form-group">
                                                <select class="form-select" name="role_name" id="my-input">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                                                    placeholder="" id="my-input" name="start_date" value="{{ $data[0]->start_date }}">
                                                <div class="form-control-icon">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                ...
                                                <textarea class="form-control edit @error('notes') is-invalid @enderror" id="editor"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($data[0]->skills_last_modified_date)->format('d-m-Y') }}</td>
                                                <td>Admin</td>
                                                @endif
                                            ...
                                            <input type="hidden" name="employee" value="{{ $data[0]->id }}">
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-select form-control-lg @error('startDate') is-invalid @enderror" name="startDate" value="{{ old('start_date') }}">
                                                @error('startDate')
                                                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            @endforeach
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('notes') is-invalid @enderror" id="editor2"
                        ...
                        <form class="form form-horizontal" action="{{ route('change/password/db') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                            <input type="password" class="form-control name="new_confirm_password" placeholder="Enter Confirm New Password">
                                                <div class="form-control-icon">
                                                <i class="bi bi-shield-lock"></i>
                                                </div>
                                                @error('name')
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                    <button class="btn btn-primary me-1 mb-1">Change Password</button>
                                        <a  href="{{ route('userManagement') }}"
                                        class="btn btn-light-secondary me-1 mb-1">Back</a>
                                    </div>
                                </div>
