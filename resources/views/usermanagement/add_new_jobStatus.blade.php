        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">For admin to input the details for new job status</p>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form class="form form-horizontal" action="{{ route('jobStatus/add/save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
