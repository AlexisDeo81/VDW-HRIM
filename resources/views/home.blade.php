...
<div id="main">
    @if (Auth::user()->role_name=='Admin' || Auth::user()->role_name=='Hr' || Auth::user()->role_name=='Manager' ||
    Auth::user()->role_name=='Team Leader' || Auth::user()->role_name=='Trainor')
                ...
                <div class="card-body">
                    ...
                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carouselfade">
                        ...
                        <ol class="carousel-indicators">
                            ...
                            <li data-bs-target="#carouselExampleFade" data-slide-to="{{ $loop->index }}" @if ($loop->
                                first) class="active" @endif></li>
                            @endforeach
                        </ol>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item item @if ($loop->first) active @endif">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <p id="my-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="tab-general" data-mdb-toggle="pill" href="#pills-general"
                                    role="tab" aria-controls="pills-general" aria-selected="true">General</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="tab-training" data-mdb-toggle="pill" href="#pills-training"
                                    role="tab" aria-controls="pills-training" aria-selected="false">Traning</a>
                            </li>
                        </ul>
                        <!-- Pills navs -->
                    ...
                    <div class="card-body">
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carouselfade">
                            ...
                            <div class="carousel-inner">
                                @foreach ($items as $item)
                                <div class="carousel-item item @if ($loop->first) active @endif">
                                    <img src="assets/images/samples/announcement_bgf.png" class="d-block w-100"
                                        alt="...">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5>{{ $item->subject }}</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="tab-general" data-mdb-toggle="pill"
